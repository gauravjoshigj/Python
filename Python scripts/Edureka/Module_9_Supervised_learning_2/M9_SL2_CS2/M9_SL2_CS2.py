...
# gyro values as predictors. Comment on the difference in accuracy between both the models. Accelerations as Independent variables
##################################################################################################
X_A = data.iloc[:, 5:8]
Y_A = data["activity"]
